                                    ...
                                    <?php foreach($employees as $index => $employee): ?>
                                        <div class="carousel-item <?= ($index === 0) ? 'active' : ''; ?>">
                                            ...
                                            <div class="team-thumb bg-<?= $employee->color?>">
                                                <h3 class="text-white mb-0"><?= $employee->firstname . ' ' . substr(ucfirst($employee->lastname), 0, 1)?></h3>
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <div class="news-thumb" data-aos="fade-up">
                                <a href="news-detail.html" class="news-image-hover news-image-hover-warning">
                                    <img src="<?=$articles[0]->src?>" class="img-fluid large-news-image news-image" alt="">
                                </a>
                                ...
                                <div class="news-text-info">
                                    <h5 class="news-title">
                                        <a href="news-detail.html" class="news-title-link"> <?=$articles[0]->title?> </a>
                                    </h5>
